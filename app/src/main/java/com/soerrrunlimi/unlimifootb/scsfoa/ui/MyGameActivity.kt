...
import com.soerrrunlimi.unlimifootb.scsfoa.databinding.ActivityMyGameBinding

class MyGameActivity : AppCompatActivity() {
    private val binding by lazy { ActivityMyGameBinding.inflate(layoutInflater) }
    ...
    private fun observeViewModel() {
        ...
        viewModel.clickLeftLD.observe(this) {
            binding.tvClickAmount.text = it.toString()
        }
